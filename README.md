...
| 3.   | [Анализ текстов](https://github.com/nightcarpenter/ToxicComments) | Анализ комментариев пользователей на токсичность | python, pandas, numpy, nltk, sklearn, CatBoost |
